...
// Taken from Chromium: src/base/basictypes.h
// Significant changes (other than naming):
//  - |DISALLOW_EVIL_CONSTRUCTORS()| removed
...
// Types that only need exist on certain systems
...
#endif  // SIMPLEPLATFORMLIB_SRC_BASICTYPES_H_
