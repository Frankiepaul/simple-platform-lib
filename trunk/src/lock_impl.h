...
// Taken from Chromium: src/base/lock_impl.h

#ifndef SIMPLEPLATFORMLIB_SRC_LOCK_IMPL_H_
#define SIMPLEPLATFORMLIB_SRC_LOCK_IMPL_H_
...
#endif  // SIMPLEPLATFORMLIB_SRC_LOCK_IMPL_H_
